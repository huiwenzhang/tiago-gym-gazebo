...
def run(env_id, seed, noise_type, layer_norm, evaluation, **kwargs):
    ...
    if evaluation and rank == 0:
        ...
        eval_env = bench.Monitor(
            eval_env, os.path.join(
                logger.get_dir(), 'gym_eval'))
...
def parse_args():
    ...
    # per epoch cycle and MPI worker. In register env: max_episode_steps?
    ...
    # this is the total timesteps, not the timesteps of the episode
